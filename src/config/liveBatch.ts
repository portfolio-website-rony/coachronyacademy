  ...
  projects: [
    {
      ...
      desc: "Messenger-এ ২৪/৭ conversation, প্রশ্নের উত্তর ও sales support পরিচালনা করবে।",
      label: "Blueprint",
    },
    {
      title: "WhatsApp AI Agent",
      desc: "Memory, lead qualification ও order handling সহ multi-turn WhatsApp agent।",
      label: "Blueprint",
    },
    {
      title: "Instagram AI Agent",
      desc: "DM funnel, story reply এবং comment-triggered workflow automate করবে।",
      label: "Blueprint",
    },
    {
      title: "Facebook Comment Automation",
      desc: "Comment থেকে auto-reply, inbox message, lead capture ও follow-up চালাবে।",
      label: "Blueprint",
    },
    {
      title: "AI Customer Support",
      desc: "Knowledge-base support agent, human handoff এবং support history সহ।",
      label: "Blueprint",
    },
    {
      title: "WooCommerce Automation",
      desc: "Order confirmation, abandoned cart, inventory alert ও customer update automate করবে।",
      label: "Blueprint",
    },
  ],
